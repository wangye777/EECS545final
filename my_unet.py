...
class UNet128 (nn.Module):
    ...
    def __init__(self, in_shape, num_classes):
        ...
        self.down1 = nn.Sequential(
            make_conv_bn_relu(1, 16, kernel_size=3, stride=1, padding=1 ),
        ...
        self.classify = nn.Conv2d(32, 2, kernel_size=1, stride=1, padding=0 )
    ...
    def forward(self, x):
        ...
        down1 = self.down1(x)
        out   = F.max_pool2d(down1, kernel_size=(2,4)) #64
        ...
        out   = F.upsample_bilinear(out, scale_factor=(2,4)) #128
